...
```{r, eval = F, echo = T}
rmarkdown::render("ST558_HW2_pdf.Rmd", 
...
# Some Core Packages {.tabset .tabset-pills}
...
```{r, eval = T, out.width = "70px" , fig.align = "center", echo = F}
...
This is some **edit** to my markdown file
